            ...
            <main className='flex w-full min-h-screen flex-col'>
                ...
                <Card className="bg-secondary flex flex-col text-slate-800 m-4 md:w-2/3 md:mx-10 md:w-2/3 md:self-center" title="Transfer Your Money">
                    ...
                    <div className='flex w-full md:w-2/3 self-center flex-col mb-4'>
                        ...
                        <div className='flex'>
                            <input id="email" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 grow-0" placeholder="321" onChange={handleRekening} type="number"/>
                    ...
                    <div className='flex w-full md:w-2/3 self-center flex-col'>
                        ...
                        <div className='flex flex-col md:flex-row'>
                            ...
                            <input id="email" aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="15.5" type='number' onChange={handleNominal} />
                        </div>
